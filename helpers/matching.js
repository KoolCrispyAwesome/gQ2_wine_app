...
if (v === "asparagus") {sauvignonBlanc += .2}
  ...
  else if (v === "chilli peppers") {rlesling += .2} 
...
if (c === "feta") {sauvignonBlanc += .2}
  ...
  else if (c === "havarti") {chardonnay += .2; rlesling += .2}
  else if (c === "gouda") {rlesling += .2}
...
if (m === "chicken") {sauvignonBlanc += .45; chardonnay += 45}
  ...
  else if (m === "duck") {rlesling += .45; zinfandel += .45}
...
if (d === "sorbet") {sauvignonBlanc += .15}
  ...
  else if (d === "apple pie") {rlesling += .15}
...
var max = Math.max(sauvignonBlanc, chardonnay, rlesling, pinotNoir, syrah, merlot, cabernetSanvignon, zinfandel)

if (max === sauvignonBlanc) {return "Sauvignon Blanc"}
  else if (max === chardonnay) {return "Chardonnay"}
  else if (max === rlesling) {return "Rlesling"}
